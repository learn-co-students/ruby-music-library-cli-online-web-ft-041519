...
The requirements for each model are that they can learn accept a `name` upon initialization and set that property correctly. The `name` property should be readable and writable by the object.
